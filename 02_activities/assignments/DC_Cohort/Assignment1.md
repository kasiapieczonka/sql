...
"When Databases Get to Define Family" by Rida Qadri demonstrates how decisions related to database design are not just computational parameters but rather important decisions that have real human consequences. Value systems and social decisions are at the core of our everyday encounters with databases, from government ID systems to health records and even social media platforms. This often results in challenges in fairness, social structures, marginalization, intersection of technology and society, etc. 

Certain databases and data systems that we encounter in our day-to-day life exhibit limitations pertaining to fairness and as a result they have inherent biases. As an example, recruitment databases may look for applicants that have pre-specified terms in their application package, thus proving disadvantageous for individuals that do not use that specific terminology across their resume and cover letter. Similarly, social media algorithms prioritize content that drives engagement, often amplifying voices and behaviours that align with mainstream norms while rendering minority perspectives less visible. In healthcare, electronic health records may emphasize data relevant to majority populations, which can disadvantage patients whose symptoms or needs fall outside those norms, reproducing inequities in care. National ID or government databases, as Rida Qadri discusses in “When Databases Get to Define Family,” can also lead to privileges for certain individuals and exclusions for others that do not fit specific assumptions. Even financial systems, such as credit scoring databases, reflect historical inequalities in lending practices, reinforcing cycles of disadvantage for marginalized groups. Across these examples, the design and operation of databases are intertwined with societal values: decisions about what to measure, how to categorize people, and which data to prioritize shape not only access to resources and opportunities but also social recognition itself, highlighting the inescapable intersection of technology and society.
